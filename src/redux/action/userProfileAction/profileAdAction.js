...
import { successMessage, errorMessage, warningMsg } from "../../../Hooks/MessageHandling";

export const getAdCategoryRequest = async () => {
...
export const getAdSubCategoryRequest = async () => {
...
export const getAdCategoryAction = () => async (dispatch) => {
    ...
    try {
        const response = await getAdCategoryRequest();
...
export const getAdSubCategoryAction = () => async (dispatch) => {
    ...
    try {
        const response = await getAdSubCategoryRequest();
...
export const postAdStoreAction = (formdata, navigate, toast) => async dispatch => {
