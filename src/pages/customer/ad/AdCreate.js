...
import SelectField from "../../../components/AdComponents/Form/Create/SelectField";
import TextField from "../../../components/AdComponents/Form/Create/TextField";
import TextAria from "../../../components/AdComponents/Form/Create/TextAria";
import Radio from "../../../components/AdComponents/Form/Create/Radio";
import {
...
import {postAdStoreAction} from "../../../redux/action/userProfileAction/profileAdAction";
...
const AdCreate = () => {
    ...
    const {adError,adStoreSuccess,loading} = useSelector(state => state.postAdStoreReducer)

    if (adStoreSuccess){
        if (adStoreSuccess.status === 201){
            // document.getElementById("adStoreForm").reset();
            setTimeout(() => {
                navigate("/payment/"+adStoreSuccess?.data?.id+"/")
            }, 500);
    ...
    useEffect(() => {
        ...
        setExtraPhoneNumber(profileData?.phone_number) 
    }, []);
    ...
    const [extraPhoneNumber,setExtraPhoneNumber] = useState(profileData?.phone_number)

    // const formHandleNumber = (e) =>{
                               ...
                               <div className="col-md-12 col-lx-6 col-sm-12 col-lg-6">
                                ...
                                <div className="col-md-12 col-lx-6 col-sm-12 col-lg-6 category__location__select">
                                    <div className="row">
                                        ...
                                        <div className="col-md-6">
                                        <div className="change__option d-flex" style={{justifyContent: "end"}}>
                                        <div className="change__option d-flex">
                                            <h5 className="mr-3">
                                                <i className="fas fa-location"></i> {' '}{subCategoryName}</h5>
                                            <a href="/ad/post"
                                               data-bs-toggle="modal" onClick={adCategoryBtn} data-bs-target="#ad__category"
                                            >{languageCheck() === 'bn' ? 'পরিবর্তন' : "Change"}</a>
                                        </div>
                                           </div>
                                        </div>
                                    ...
                                    <div className="col-md-12 col-lx-6 col-sm-12 col-lg-6 m-auto">
                                                        ...
                                                        subCategory['un-common-field'].map((field, index) => (
                                                                Object.keys(field).map(function (key, index2) { 
                                                                    ...
                                                                    if (inputFieldType === 'select') {
                                                                        return <SelectField key={index2 + index}
                                                                                            LName={inputFieldLavelName}
                                                                                            options={field[key]}/>
                                                                    }
                                                                    if (inputFieldType === 'text') {
                                                                        return <TextField key={index2 + index}
                                                                                          LName={inputFieldLavelName}/>
                                                                    }
                                                                    if (inputFieldType === 'textaria') {
                                                                        return <TextAria key={index2 + index}
                                                                                         LName={inputFieldLavelName}/>
                                                                    }
                                                                    if (inputFieldType === 'radio') {
                                                                        return <Radio key={index2 + index}
                                                                                      LName={inputFieldLavelName}
                                                                                      options={field[key]}/>
                                                                    }
                                                                    // if (inputFieldType === 'checkbox') {
                                                                    //     return <Checkbox key={index2 + index}
                                                                    //                   LName={inputFieldLavelName}
                                                                    //                   options={field[key]}/>
                                                                    // }
                                                                })
                                      ...
                                      {/* pricing */}
                                        ...
                                        <div className="row d-flex align-items-center">
                                            <div className="col-7">
                                                <div className="form-group">
                                                    ...
                                                    />
                                              <span style={{color:'red'}}>{adError?.price?.map((error)=>(error?.message))}</span>
                                                </div>
                                            </div>
                                            <div className="col-5">
                                                <input
                                        ...
                                        <div className="row d-flex align-items-center">
                                            ...
                                            <div className={
                                                ...
                                                <div className={newConditionCategoryList.includes(adCategoryName) === true ? "d-none" : "radio__no mr-2"}>
                                                    <label htmlFor="secondhand" className="mr-2">
                                                        <input value="Used" type="radio"
                                                               name="condition" id="secondhand"/>
                                                    </label>
                                                    <span>{languageCheck() === 'bn' ? 'ব্যবহৃত' : "Used"}</span>
                                                </div> 
                                                <div className={reConditionSubCategoryList.includes(subCategoryName) === true ? "radio__no mr-2" : "d-none"}>
                                                    ...
                                                    <div className="work_experiences d-flex w-100">
                                                        <div style={{paddingLeft: "0"}} className="form-check">
                                                            <input
                                                                ...
                                                                onChange={formHandle}
                                                                onClick={CheckAdvertisementVisible}
                                                            />
                                            ...
                                            <div className={"form-group"}>
                                                <h5 className={'mb-3'}>
                                                {languageCheck() === 'bn' ? '5 টি পর্যন্ত ফটো যোগ করুন' : "Add up to 5 photos"}
                                                </h5>
                                                <div className="d-flex ad__image__all__show">
                                                    {/*image 1*/}

                                                    <div
                                                        className="image-upload-section d-flex flex-column justify-content-start mr-2">
                                                        <span style={{ fontSize: '10px' }} id={firstImageCheck} className={firstImageCheck === 'true' ? 'text-danger' : 'd-none'}>
                                        ...
                                        <div className="row d-flex align-items-center">
                                            ...
                                            <div className="col-sm-12">
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    {languageCheck() === 'bn' ? 'আপনার ফোন নম্বরটি  পরিবর্তন করতে পারেন' : "You can change your phone number"}
                                                    </label> 
                                                    <input 
                                                    type="text"
                                                    ...
                                                    placeholder={languageCheck() === 'bn' ? 'আপনার ফোন নম্বরটি  পরিবর্তন করতে পারেন' : "You can change your phone number"}
                                                    />
                                                </div>
                                            ...
                                            <div className="login__btn">
                                                ...
                                                className={ loading || checkAdvertisementVisible === true ? "loading__button mt-20 log-in":"main-btn btn__small mt-20 log-in customDisabled"}>
                                                {loading ?
